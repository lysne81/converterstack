...
import type { ArticleDefinition } from "../../articles/articles";

/**
 * Cross-links a published article to other curated, topically related
 * articles (via `relatedArticleSlugs`), distinct from `RelatedArticles`,
 * which links converter pages to articles.
 */
